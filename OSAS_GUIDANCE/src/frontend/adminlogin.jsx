  ...
  return (
    <div className="w-screen h-screen bg-gray-900 flex overflow-hidden">
      ...
      <div className="w-full md:w-[55%] h-full flex flex-col items-center justify-center p-6 md:p-8 text-center bg-white">
        ...
        <div className="mt-2 flex flex-col items-center space-y-4 w-full max-w-xs">
          <p className="text-xl md:text-2xl font-bold text-gray-800 tracking-wide">
            Welcome, ADMIN
          </p>
          <button
            onClick={() => navigate("/admin-login2")}
            className="w-full bg-green-600 hover:bg-green-700 text-white font-bold text-lg md:text-xl py-3 mt-4 rounded-full shadow-md"
          >
            LOGIN ADMIN ACCOUNT
          </button>
        </div>
