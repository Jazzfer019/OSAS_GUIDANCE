      ...
      <div className="w-full md:w-[55%] h-full flex flex-col items-center justify-center p-6 md:p-8 text-center bg-white">
        ...
        <div className="w-full max-w-xs space-y-4">
          <button    
            ...
            className="w-full flex items-center justify-center gap-2 md:gap-3 bg-green-600 hover:bg-green-700 text-white font-semibold py-2 md:py-3 rounded-full transition text-sm md:text-lg">
            <UserIcon className="w-4 h-4 md:w-5 md:h-5" />
            <span>STUDENT</span>
          </button>
          <button
            onClick={() => navigate("/admin-login")}
            className="w-full flex items-center justify-center gap-2 md:gap-3 bg-yellow-400 hover:bg-yellow-500 text-black font-semibold py-2 md:py-3 rounded-full transition text-sm md:text-lg"
          >
